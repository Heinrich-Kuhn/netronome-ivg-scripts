...
echo "ovs-vsctl add-port $BRIDGE_NAME $repr_vf4 -- set interface $repr_vf4 ofport_request=44"
ovs-vsctl add-port $BRIDGE_NAME $repr_vf4 -- set interface $repr_vf4 ofport_request=44
