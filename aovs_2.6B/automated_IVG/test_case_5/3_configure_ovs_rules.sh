...
# Add VF ports
ovs-vsctl add-port $BRIDGE nfp_v0.20 -- set interface nfp_v0.20 ofport_request=20 external_ids:virtio_relay=20
ovs-vsctl add-port $BRIDGE nfp_v0.21 -- set interface nfp_v0.21 ofport_request=21 external_ids:virtio_relay=21
