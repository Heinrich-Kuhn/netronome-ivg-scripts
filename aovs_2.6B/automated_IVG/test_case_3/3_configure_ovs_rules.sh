...
ovs-vsctl add-port $BRIDGE nfp_v0.42 -- set interface nfp_v0.42 ofport_request=42 external_ids:virtio_relay=42
ovs-vsctl add-port $BRIDGE nfp_v0.43 -- set interface nfp_v0.43 ofport_request=43 external_ids:virtio_relay=43
