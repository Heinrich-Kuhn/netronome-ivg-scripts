...
sed "s#^VIRTIOFWD_STATIC_VFS=.*#VIRTIOFWD_STATIC_VFS=($VF1_PCI_ADDRESS=25 $VF2_PCI_ADDRESS=26 $VF3_PCI_ADDRESS=27 $VF4_PCI_ADDRESS=28)#g" -i /etc/default/virtioforwarder
